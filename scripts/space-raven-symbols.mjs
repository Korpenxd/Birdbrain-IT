...
const variants = {
  ...
  "raven-process-progress.svg": {
    ...
    replacement: '<polyline points="150,932 232,843 286,840 345,760" fill="none" stroke="url(#raven-symbol-gradient)" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/><path d="M313 758L347 758L344 792" fill="none" stroke="url(#raven-symbol-gradient)" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/><circle cx="150" cy="932" r="13" fill="#071323" stroke="#61e7ff" stroke-width="6"/><circle cx="232" cy="843" r="13" fill="#071323" stroke="#768cff" stroke-width="6"/><circle cx="286" cy="840" r="11" fill="#071323" stroke="#d45cff" stroke-width="5"/>',
  },
